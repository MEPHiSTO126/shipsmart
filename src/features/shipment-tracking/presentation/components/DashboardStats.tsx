...
export function DashboardStats({ summary }: DashboardStatsProps) {
  ...
  const inTransitCount = useCountUp(summary.inTransit, 0.8, prefersReducedMotion);
  const delayedCount = useCountUp(summary.delayed, 0.8, prefersReducedMotion);
  const outForDeliveryCount = useCountUp(summary.outForDelivery, 0.8, prefersReducedMotion);
  const deliveredCount = useCountUp(summary.delivered, 0.8, prefersReducedMotion);
